...
for (t in 1:(n.years-1)){
  ...
  ### Isn't this a problem that I used FR[t+1] later?
}
...
cat("
    ...
    logPupdate[t] <- logP[t] + r_P + epsilon*FR[t+1]
...
parameters<-c("r_V","K_V","r_P","epsilon","sigma2_V","sigma2_P","C","D","logNupdate","logPupdate","FR")
...
### Some serious discrepancy there though... 
