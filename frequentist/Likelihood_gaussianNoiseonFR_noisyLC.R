...
### FB 01/02/2019 -- changed analyses to noisy LC parameter
...
### Some difficulty with T=1000 - check that out!!
...
theta_start = c(runif(1,0.5,2),runif(1,0.001,5),runif(1,0.05,1),runif(1,0.1,1),runif(1,0.1,5),runif(1,0.05,1),runif(1,2,30),runif(1,0.1,1),runif(1,0.05,1))
...
theta_true
theta_start
# needs more iteration than the default it seems. 
